	...
	public class service 
	{
	     ...
	     public void create(Employee e) throws SQLException, IOException
	     {
	    	ms.initDB();
	    	 ...
	    	 if(count>0)
	    	 {
	    		 System.out.println("Employees is inserted");   		 
	    	 }
	    	 else
	    	 {
	    		 System.out.println("error while inserting employees details");
	    	 }
		    ms.closeDB();
	     ...
	     public void update(Employee e) throws SQLException,IOException 
	     {
	    	 ...
	    	 ms.initDB();
	    	  ...
	    	  if(count>0)
	    	  {
	    		  System.out.println("Employees details are updated");
	    	  }
	    	  else
	    	  {
	     ...
	     public void deleteByEmail(String emailId) throws SQLException, IOException 
	     {
	    	 ms.initDB();
	    	  ...
	    	  if(count>0)
	    	  {
	    		  System.out.println("employees details got deleted");
	    	  }
	    	  else
	    	  {
	    ...
	    {
	    	HashMap<String,Employee> employeeTable=ms.getEmployeesTable();
