...
public class MysqlImp implements Interface
{
    Connection con=null;
    Statement st=null;
    ...
    private HashMap<String,Employee> employeesTable=new HashMap<String,Employee>();
    
   
	
	public HashMap<String, Employee> getEmployeesTable() {
		return employeesTable;
	}
	

	public void setEmployeeTable(HashMap<String, Employee> employeeTable) {
		this.employeesTable = employeeTable;
	}
	...
	public void initDB() throws SQLException, IOException {
		...
		try {
         ...
         con=DriverManager.getConnection("jdbc:mysql://localhost:3306/LVDS","root","Rajitha@9652");  
	...
	public int create(Employee e) throws SQLException
	{
		...
		pst=con.prepareStatement("insert into LVDS.employees values(?,?,?,?,?,?,?)");
		String get_empid="select coalesce((select max(id)+1 from LVDS.employees),1) as getid";
	...
	public int update(Employee e) throws SQLException {
		...
		pst=con.prepareStatement("update employees set age=? where emailId=? and name=? ");
	...
	{
		pst=con.prepareStatement("delete from employees where emailId=?");
	...
	public Employee getEmployeeByEmail(String emailId) throws SQLException {
		...
		pst=con.prepareStatement("select * from employees where emailId=?");
